///*
//This mJava class defines a Replacement_Parts model that extends the Product class
...
//Encapsulation: Private attribute partFor accesed via getter/setter.
...
//    public Replacement_Parts(String productNameIn, double priceIn, int stockLevelIn, String partForIn)
//    {
...
//    public Replacement_Parts(int productIdIn,String productNameIn, double priceIn, int stockLevelIn,
//            double efficiencyRatingIn,String partForIn)
//    {
//        // when you do a call do not write the variable type      
